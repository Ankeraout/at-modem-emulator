...
# 6 "src/protocols/hayes.h" 2

# 1 "src/client.h" 1
# 8 "src/protocols/hayes.h" 2




# 11 "src/protocols/hayes.h"
enum te_hayesState {
    E_HAYESSTATE_CMD,
    E_HAYESSTATE_CMD_A,
    E_HAYESSTATE_CMD_AT,
...
# 35 "src/protocols/hayes.h" 3 4
   _Bool 
# 35 "src/protocols/hayes.h"
        commandReject;
    char commandName;
...
# 40 "src/protocols/hayes.h" 3 4
   _Bool 
# 40 "src/protocols/hayes.h"
        echo;
    
# 41 "src/protocols/hayes.h" 3 4
   _Bool 
# 41 "src/protocols/hayes.h"
        quiet;
    
# 42 "src/protocols/hayes.h" 3 4
   _Bool 
# 42 "src/protocols/hayes.h"
        verbose;
    uint8_t regS[13];
};
...
# 9 "src/client.h" 2
# 1 "src/protocols/hdlc.h" 1



# 1 "/usr/lib/gcc/x86_64-linux-gnu/10/include/stddef.h" 1 3 4
# 5 "src/protocols/hdlc.h" 2
...
struct ts_hdlcContext {
    uint8_t recvFrameBuffer[1536];
    
# 13 "src/protocols/hdlc.h" 3 4
   _Bool 
# 13 "src/protocols/hdlc.h"
        recvEscape;
...
void hdlcSend(struct ts_client *p_client, uint8_t *p_buffer, size_t p_size);
# 10 "src/client.h" 2
# 1 "src/protocols/ppp.h" 1
# 11 "src/client.h" 2
# 1 "src/protocols/ipv4.h" 1



# 1 "/usr/lib/gcc/x86_64-linux-gnu/10/include/stddef.h" 1 3 4
# 5 "src/protocols/ipv4.h" 2
...
int main(void) {
    ...
    struct in6_addr l_socketAddress = 
# 19 "src/modem.c" 3 4
...
# 42 "src/modem.c" 3 4
                   stderr
# 42 "src/modem.c"
                         , "Warning: serverAccept() failed. Exiting...\n");
            break;
        }
...
# 48 "src/modem.c" 3 4
                   stderr
# 48 "src/modem.c"
                         , "Warning: failed to accept new client.\n");
        }
    }
